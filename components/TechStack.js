...
const TechStack = () => {
    return (
        <section>
            ...
            <p className="paragraph">Strong foundational knowledge of <b>HTML</b>, <b>CSS</b>, and <b>JavaScript</b>. <b>SASS</b> for browser compatible CSS and developer-friendly syntax and features. <b>JQuery</b> for frontend enhancement purposes. <b>Express</b> for REST applications and easy middleware management. <b>MongoDB</b> for NoSQL database connection to the web applications. <b>React</b> for code reusability and performance enhancement. <b>Material UI</b> for pre-styled React Components for fast frontend development. <b>Next.js</b> for super fast performance from Server Side Rendering and for improved SEO. </p>
        </section>
     );
}
